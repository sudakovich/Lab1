...
void ProcessClient(SOCKET hSock)
{
    ...
    switch (m.Receive(s))
        ...
        case M_EXIT:
        {
            ...
            cout << m.m_Header.m_From << " Disconnected" << endl;
...
void LaunchClient()
{
    ...
    CreateProcessA((LPSTR)"C:\\Users\\Сергей\\Desktop\\tris_2020-master\\MsgServer\\x64\\Debug\\MsgClient.exe", NULL, NULL, NULL, TRUE, CREATE_NEW_CONSOLE, NULL, NULL, &si, &pi); // Путь
